<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="http://web9.vtdns.net/css/ontheme/animate.css">
      <link rel="stylesheet" href="http://web9.vtdns.net/css/ontheme/category-feature.css">
      <link rel="stylesheet" href="http://web9.vtdns.net/css/ontheme/lightbox.css">
      <link rel="stylesheet" href="http://web9.vtdns.net/css/stylesheet.css">
      <link href='https://fonts.googleapis.com/css?family=Roboto:300,400,500,700,900' rel='stylesheet' type='text/css'>
      <link href='https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700' rel='stylesheet' type='text/css'>
      <link rel="stylesheet" href="http://web9.vtdns.net/css/opencart.css">
      <link rel="stylesheet" href="http://web9.vtdns.net/css/swiper.css">
      <link rel="stylesheet" href="http://web9.vtdns.net/css/swiper.min.css">
      <link rel="stylesheet" href="http://web9.vtdns.net/css/owl.carousel.css">
      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.carousel.min.css">
      <link rel="stylesheet" href="http://web9.vtdns.net/js/jquery/magnific/magnific-popup.css">
      <link rel="stylesheet" href="http://web9.vtdns.net/js/jquery/datetimepicker/bootstrap-datetimepicker.min.css">
      <link rel="stylesheet" href="http://web9.vtdns.net/js/font-awesome/css/font-awesome.min.css">
      <link rel="stylesheet" href="http://web9.vtdns.net/css/jquery-ui.css">
      <link rel="stylesheet" href="http://web9.vtdns.net/css/zoomple.css">
      <link rel="stylesheet" href="http://web9.vtdns.net/choosen/css/chosen.min.css">
   ...
   <body>
                              ...
                              <div class="product-layouts">
                                 <div class="product-thumb transition">
                                    ...
                                    <div class="thumb-description">
                                       <div class="caption">
                                          <h4><a href="http://web9.vtdns.net/wheels?brand=WyJLb2tvIl0=">Koko Sardinia5 <br> Diameter : 18 </a></h4>
                                          <br>
                                          <button class="btn btn-primary " data-toggle=modal data-target="#myModal0" onclick="WheelMapping('0')" >See On Your Car</button>
                                       </div>
                                       </div>
                                    </div>
                                 </div>
      ...
      <!-- Main End -->
      <!-- Javascript Start -->
      <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="http://web9.vtdns.net/js/jquery.min.js"></script>
      <script src="http://web9.vtdns.net/js/jquery-2.1.1.min.js"></script>
      <script src="http://web9.vtdns.net/js/bootstrap.min.js"></script>
      <script src="http://web9.vtdns.net/js/slick.js"></script>
      <script src="http://web9.vtdns.net/js/ontheme/bootstrap-notify.min.js"></script>
      <script src="http://web9.vtdns.net/js/ontheme/jquery.elevatezoom.min.js"></script>
      <script src="http://web9.vtdns.net/js/ontheme/lightbox-2.6.min.js"></script>
      <script src="http://web9.vtdns.net/js/swiper.jquery-.js"></script>
      <script src="http://web9.vtdns.net/js/swiper.js"></script>
      <script src="http://web9.vtdns.net/js/swiper.min.js"></script>
      <script src="http://web9.vtdns.net/js/owl.carousel.min.js"></script>
      <script src="http://web9.vtdns.net/js/jquery-ui.js"></script>
      <script src="http://web9.vtdns.net/js/zoomple.js"></script>
      <script src="http://web9.vtdns.net/js/wheel_vehicle_flow.js"></script>
      <script src="http://web9.vtdns.net/js/ajax/jquery.min.js"></script>
      <script src="http://web9.vtdns.net/choosen/js/chosen.jquery.min.js"></script>
      <script src="http://web9.vtdns.net/js/slick.js"></script>
      <script  src="http://web9.vtdns.net/js/opencv/opencv-3.3.1.js" async></script>
      <script type="text/javascript">
         ...
         function getWheelPosition(key){   
            // $.getJSON("?action=query&prop=revisions&rvprop=content",
            // function(data) {
            ...
            $.ajax({
             ...
             // $.ajax({url: "http://web9.vtdns.net/api/WheelByVehicle",data:data,
             //      crossDomain:true, 
             //      type:'POST',
      ...
      <script src="http://web9.vtdns.net/js/tire_product_search.js"></script>
      <script src="http://web9.vtdns.net/js/wheel_product_search.js"></script>
      <script src="http://web9.vtdns.net/js/wheel_visualiser.js"></script>
      <script src="http://web9.vtdns.net/js/common_search.js"></script>
      <script src="http://web9.vtdns.net/js/popImg.js"></script>
      <!-- <script src="http://web9.vtdns.net/js/opencv/opencv-3.3.1.js" async></script> -->
   </body>
</html>